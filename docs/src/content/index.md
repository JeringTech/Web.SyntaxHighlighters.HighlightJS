...
<div class="banner-small">
    ...
    <h1>Jering.<wbr>Web.<wbr>Syntax<wbr>Highlighters.<wbr>HighlightJS</h1>
    <!-- Use p so it is used in search snippet -->
    <p>Use the Syntax Highlighter, <a href="https://highlightjs.org/">HighlightJS</a>, from C#</p>
</div>
<div class="content">
    <div class="card-set card-small">
        ...
        <section class="card">
            ...
            <a href="https://github.com/JeringTech/Web.SyntaxHighlighters.HighlightJS" class="card-body">
                <header>
                    <h3>Github</h3>
                </header>
        ...
        <section class="card">
            ...
            <a href="https://www.nuget.org/packages/Jering.Web.SyntaxHighlighters.HighlightJS/" class="card-body">
                <header>
                    <h3>Nuget</h3>
                </header>
